...
<script type="text/javascript">
	...
	<div url="${pageContext.request.contextPath}/blog/saveBlog.action" id="url" 
		 ...
		 <div class="row">
		 	<div class="col-md-9">
		 		关键字：
		 		<input type="text" id="keyWord" name="keyWord" style="width: 55%;"/>&nbsp;(多个关键字中间用空格隔开)
	 		</div>
		 	<div class="col-md-3" style="text-align: right;">
	 			<a href="javascript:void(0)" onclick="submitData()" class="btn btn-default" role="button" >发布博客</a>
	 		</div>
		</div>	 
